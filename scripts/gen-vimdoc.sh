...
# file is never hand-aligned. Edit doc/bemtvi-lspconfig.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="bemtvi-lspconfig"                             # → :help bemtvi-lspconfig
DESCRIPTION="Ready-made btv.lsp server configs for bemtvi"  # header tagline (line 1)
# -----------------------------------------------------------------------------
