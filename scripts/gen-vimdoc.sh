...
# file is never hand-aligned. Edit doc/nxvim-lspconfig.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="nxvim-lspconfig"                             # → :help nxvim-lspconfig
DESCRIPTION="Ready-made nx.lsp server configs for nxvim"  # header tagline (line 1)
# -----------------------------------------------------------------------------
